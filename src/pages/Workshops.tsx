...
class Workshops extends React.Component<IProps, IState> {
  ...
  handleLinkClick(e: React.MouseEvent<HTMLAnchorElement, MouseEvent>, id: string) {
    e.preventDefault()
    let el = document.getElementById(id)
    el?.scrollIntoView({behavior: 'smooth', block: 'start'})
  }

  handleOfferRadio(e: React.MouseEvent) {
    let registerOfferPrice = document.getElementById('registerOfferPrice')
    this.setState({
      selectedOffer: (e.target as HTMLInputElement).value
    }, () => {
      // @ts-ignore
  ...
  handleRegisterWorkshop(e: React.MouseEvent<HTMLButtonElement, MouseEvent>, t: TFunction) {
