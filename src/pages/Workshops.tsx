...
export const Workshops: React.FC = () => {
  const {t, i18n} = useTranslation(['Workshops', 'Meta'])
  ...
  return (
    <>
      <Helmet>
        <title>{t('Meta:title.workshops')}</title>
        <meta name="description" content={t('Meta:description.workshops')}/>
        {i18n.language === 'fr'
          ? <link rel="canonical" href="https://www.bitcoin-studio.com/fr/formations"/>
          : <link rel="canonical" href="https://www.bitcoin-studio.com/workshops"/>}
      </Helmet>
